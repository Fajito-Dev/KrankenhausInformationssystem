        ...
        btnAddPatient.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    entryModel = new EntryModel(0, Integer.parseInt(edtPatientenId.getText().toString()),0,dataBaseHelper.getFreeBed(),0,"ohneBefund",false, false,"Patient eingewiesen",0,0,0);
